...
async def ask(ctx, *, question: str):
    async with ctx.typing():
        ...
        prompt_context = (
            ...
            f"- ถ้าระบุตัวเลข (เช่น หุ้น, ทอง, น้ำมัน) ให้เช็ก 'วันที่' ในข้อมูลเสมอ ถ้าข้อมูลมันเก่า (เช่นเป็นของปี 2024-2025) ให้บอกตรงๆ ว่า 'ลุงเจอแต่ของเก่าปี... ว่ะ' ห้ามมโนตัวเลขหรือแต่งเรื่องเองเด็ดขาด\n"
            f"- ถ้าในเน็ตไม่มีข้อมูลที่หลานถาม ก็ตอบแมนๆ ไปเลยว่า 'หาไม่เจอว่ะหลาน' หรือ 'ข้อมูลมันยังไม่อัปเดต'\n\n"
